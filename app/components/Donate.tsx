...
const Donate = () => {
  return (
    <section className=" w-full h-screen p4  z-50 flex lg:px-32 lg:flex-row flex-col items-center justify-center  bg-gray-200  top-0 absolute green">
      ...
      <div className="flex flex-col  my-auto gap-3 px-8 max-w-2xl text-gray-800  items-end  justify-center  ">
              ...
              card: (
                <div className="flex  flex-col gap-2">
                  <Link
                    ...
                    target="_blank"
                    key={i}
                    className=" rounded-full overflow-hidden w-32 h-32 relative"
                  >
