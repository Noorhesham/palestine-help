...
const SecondScene = ({ text, text2 }: { text: string; text2: string }) => {
  return (
    <div className=" relative z-20 overflow-hidden   h-screen second">
      ...
      <div
        className="flex w-full  gap-10 md:flex-row flex-col  px-5 lg:px-20 justify-between opacity-0   py-10 left-10
       lg:left-44 top-20 intro2"
      >
        <div className=" flex-col flex w-full lg:w-[70%] h-full   flex-grow relative">
        ...
        <div
          ...
          className="nakba w-full rounded-2xl overflow-hidden h-72   relative"
        >
          <Image fill src="/nakba.jpg" className=" object-cover" alt="bleed" />
        </div>
      </div>

      <div className="flex px-5  gap-10 ml-3 lg:ml-32 mt-10 relative w-full h-full">
        <ParagraphWrite className="  paragraph2  relative z-30 max-w-md !text-left" text={text} />
        <div className=" flex lg:flex-row flex-col gap-2">
          {" "}
          <div className="nakba2 translate-x-[-200px]  lg:mt-20 w-52 lg:w-96 opacity-0 rounded-2xl overflow-hidden relative  h-72   ">
